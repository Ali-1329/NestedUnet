...
if __name__ == "__main__":
    ...
    create_dir("/content/drive/MyDrive/clinic_resunest_results/")
    ## Dataset
    test_path = '/content/clinic_test'
    batch_size = 6
    ...
    model = load_model_weight("/content/drive/MyDrive/files5_clinic/model.h5")
    ...
    for i, (x, y) in tqdm(enumerate(zip(test_x, test_y)), total=len(test_x)):
        ...
        cv2.imwrite(f"/content/drive/MyDrive/clinic_resunest_results/{i}.jpg", image)
